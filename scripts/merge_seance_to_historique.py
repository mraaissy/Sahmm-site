...
NOM_VERS_TICKER = {
    ...
    # Alias supplémentaires observés dans les exports CSV (format différent
    # de celui des fichiers Excel de séance)
    ...
    "SOCIETE MAGHREBINE DE MONETIQUE": "S2M",
    ...
    "SOCIETE DE THERAPEUTIQUE MAROCAINE": "SOT",
    "SOCIETE DE REALISATIONS MECANIQUES": "SRM",
    "SOCIETE DE TRAVAUX DE REALISATION D'OUVRAGES ET DE CONSTRUCTION INDUSTRIELLE": "STR",
    "TRAVAUX GENERAUX DE CONSTRUCTION DE CASABLANCA": "TGC",
